...
This module contains pylint rule codes that provide functionality that overlaps
with what mypy already provides. When mypy is used in a project, these rules
